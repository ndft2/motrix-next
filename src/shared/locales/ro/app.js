export default {
  ...
  'engine-stopped': 'Motorul Aria2 Next s-a oprit',
  ...
  'engine-dismiss-warning': 'Motorul de descarcare Aria2 Next nu ruleaza, poate aparea un comportament neasteptat',
  'engine-verifying-stability': 'Motorul de descarcare Aria2 Next a pornit, se verifica stabilitatea...',
  ...
  'protocol-hijacked-dialog-content': 'S-a detectat că protocolul {protocols} nu este asociat cu Motrix Next, iar linkurile aferente nu vor putea deschide automat programul.\nAcest lucru este cauzat de obicei de o instalare inițială, o actualizare de versiune sau un alt instrument de descărcare care a preluat asocierea. Puteți reactiva asocierea protocolului corespunzător în Setări → Setări avansate.',
  'dismiss': 'Am înțeles',
