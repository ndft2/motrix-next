export default {
  ...
  'engine-stopped': 'محرك Aria2 Next متوقف',
  ...
  'engine-dismiss-warning': 'محرك التنزيل Aria2 Next لا يعمل، قد يحدث سلوك غير متوقع',
  'engine-verifying-stability': 'تم تشغيل محرك التنزيل Aria2 Next، جارٍ التحقق من الاستقرار...',
  ...
  'protocol-hijacked-dialog-content': 'تم اكتشاف أن بروتوكول {protocols} غير مرتبط بـ Motrix Next، ولن يتمكن من فتح الروابط ذات الصلة تلقائيًا.\nيحدث هذا عادةً بسبب التثبيت لأول مرة أو تحديث الإصدار أو برنامج تنزيل آخر استولى على الارتباط. يمكنك إعادة تفعيل ارتباط البروتوكول المقابل في الإعدادات ← الإعدادات المتقدمة.',
  'dismiss': 'حسناً',
