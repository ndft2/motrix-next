export default {
  ...
  'engine-stopped': 'Aria2 Next エンジンが停止しました',
  ...
  'engine-retry': '再試行',
  'engine-dismiss-warning': 'Aria2 Next ダウンロードエンジンが実行されていません — 予期しない動作が発生する可能性があります',
  'engine-verifying-stability': 'Aria2 Next ダウンロードエンジンを起動しました。安定性を確認中...',
