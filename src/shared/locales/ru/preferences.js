export default {
  ...
  'hardware-rendering-hint':
    'Аппаратное ускорение WebKitGTK DMA-BUF включено по умолчанию для оптимальной производительности. Если на вашем GPU появляется белый экран или сбой, отключите эту опцию для перехода на программный рендеринг.',
  'hardware-rendering-restart-confirm':
    'Аппаратное ускорение WebKitGTK DMA-BUF должно быть настроено до запуска процесса и требует перезапуска приложения. Некоторые GPU (напр. проприетарные NVIDIA, Intel + Wayland, Raspberry Pi) могут быть несовместимы. Если приложение аварийно завершится после включения, параметр будет автоматически отключён.',
