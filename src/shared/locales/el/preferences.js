export default {
  ...
  'hardware-rendering-hint':
    'Η επιτάχυνση WebKitGTK DMA-BUF είναι ενεργοποιημένη από προεπιλογή για βέλτιστη απόδοση. Αν παρατηρήσετε λευκή οθόνη ή κατάρρευση με την τρέχουσα κάρτα γραφικών, απενεργοποιήστε αυτή την επιλογή για εναλλαγή σε λογισμικό rendering.',
  'hardware-rendering-restart-confirm':
    'Η επιτάχυνση WebKitGTK DMA-BUF πρέπει να ρυθμιστεί πριν την εκκίνηση της διεργασίας, επομένως απαιτείται επανεκκίνηση. Ορισμένες κάρτες γραφικών (π.χ. NVIDIA ιδιόκτητο, Intel + Wayland, Raspberry Pi) ενδέχεται να μην είναι συμβατές. Αν η εφαρμογή καταρρεύσει μετά την ενεργοποίηση, θα απενεργοποιηθεί αυτόματα.',
  ...
  'protocol-disable-ext-warning':
    'Οι επεκτάσεις του προγράμματος περιήγησης δεν θα μπορούν να στείλουν εργασίες λήψης στο Motrix Next',
