export default {
  ...
  'proxy-http-only-hint': 'Aria2 Next підтримує лише HTTP-проксі. SOCKS-проксі не підтримується.',
  ...
  'hardware-rendering-restart-confirm':
    'Апаратне прискорення WebKitGTK DMA-BUF потрібно налаштувати до запуску процесу, тому потрібен перезапуск застосунку. Деякі GPU (напр. пропрієтарні NVIDIA, Intel + Wayland, Raspberry Pi) можуть бути несумісними. Якщо програма аварійно завершиться після увімкнення, параметр буде автоматично вимкнено.',
  ...
  'auto-select-all-files-from-extension-hint': 'Якщо ввімкнено, усі завдання запускатимуться тихо.',
