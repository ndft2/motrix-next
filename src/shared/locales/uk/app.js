export default {
  ...
  'engine-stopped': 'Рушій Aria2 Next зупинено',
  ...
  'engine-dismiss-warning': 'Рушій завантаження Aria2 Next не запущено, можлива непередбачувана поведінка',
  'engine-verifying-stability': 'Рушій завантаження Aria2 Next запущено, перевірка стабільності...',
  ...
  'protocol-hijacked-dialog-content': 'Виявлено, що протокол {protocols} не прив\'язаний до Motrix Next, і відповідні посилання не зможуть автоматично відкривати програму.\nЗазвичай це спричинено першим встановленням, оновленням версії або іншим інструментом завантаження, який перехопив прив\'язку. Ви можете повторно увімкнути відповідну прив\'язку протоколу в Налаштування → Розширені налаштування.',
  'dismiss': 'Зрозуміло',
