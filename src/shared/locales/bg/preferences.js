export default {
  ...
  'hardware-rendering-hint':
    'WebKitGTK DMA-BUF хардуерно ускорение е включено по подразбиране за най-добра производителност. Ако срещнете бял екран или срив с текущата видеокарта, изключете тази опция за софтуерно рендериране.',
  'hardware-rendering-restart-confirm':
    'WebKitGTK DMA-BUF хардуерното ускорение трябва да се конфигурира преди стартиране на процеса, затова е необходимо рестартиране. Някои видеокарти (напр. NVIDIA собствен драйвер, Intel + Wayland, Raspberry Pi) може да не са съвместими. Ако приложението се срине след включване, ще се изключи автоматично.',
  ...
  'protocol-disable-ext-warning':
    'Разширенията на браузъра няма да могат да изпращат задачи за изтегляне към Motrix Next',
