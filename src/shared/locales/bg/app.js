export default {
  ...
  'engine-stopped': 'Двигателят Aria2 Next е спрян',
  ...
  'engine-dismiss-warning': 'Двигателят за изтегляне Aria2 Next не работи, възможно е неочаквано поведение',
  'engine-verifying-stability': 'Двигателят за изтегляне Aria2 Next е стартиран, проверка на стабилността...',
  ...
  'protocol-hijacked-dialog-content': 'Открито е, че протоколът {protocols} не е свързан с Motrix Next и съответните връзки няма да могат да отварят програмата автоматично.\nТова обикновено се дължи на първоначална инсталация, актуализация на версията или друг инструмент за изтегляне, който е превзел асоциацията. Можете да активирате отново съответната асоциация в Настройки → Разширени настройки.',
  'dismiss': 'Разбрах',
