export default {
  ...
  'proxy-http-only-hint': 'Aria2 Next는 HTTP 프록시만 지원합니다. SOCKS 프록시는 지원하지 않습니다',
  ...
  'auto-select-all-files-from-extension-hint': '켜면 모든 작업이 조용히 시작됩니다',
  ...
  timeout: '전송 시간 초과',
  'async-dns': '비동기 DNS',
  'async-dns-hint': '성능이 향상될 수 있지만 불안정하거나 다운로드가 안 될 수 있습니다',
