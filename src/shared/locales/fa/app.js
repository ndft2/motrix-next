export default {
  ...
  'engine-stopped': 'موتور Aria2 Next متوقف شد',
  ...
  'engine-dismiss-warning': 'موتور دانلود Aria2 Next در حال اجرا نیست، ممکن است رفتار غیرمنتظره رخ دهد',
  'engine-verifying-stability': 'موتور دانلود Aria2 Next راه‌اندازی شد، در حال بررسی پایداری...',
  ...
  'protocol-hijacked-dialog-content': 'تشخیص داده شد که پروتکل {protocols} به Motrix Next متصل نیست و لینک‌های مربوطه نمی‌توانند برنامه را به صورت خودکار باز کنند.\nاین معمولاً به دلیل نصب اولیه، به‌روزرسانی نسخه یا ابزار دانلود دیگری که اتصال را گرفته است رخ می‌دهد. می‌توانید اتصال پروتکل مربوطه را در تنظیمات ← تنظیمات پیشرفته مجدداً فعال کنید.',
  'dismiss': 'متوجه شدم',
