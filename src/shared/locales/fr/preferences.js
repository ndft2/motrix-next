export default {
  ...
  'proxy-http-only-hint': "Aria2 Next ne prend en charge que le proxy HTTP. Le proxy SOCKS n'est pas pris en charge.",
  ...
  'protocol-disable-ext-warning':
    'Les extensions de navigateur ne pourront plus envoyer de tâches de téléchargement à Motrix Next',
  ...
  'async-dns-hint': 'Peut améliorer les performances, mais peut être instable ou bloquer les téléchargements',
