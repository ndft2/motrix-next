export default {
  ...
  'proxy-mode-direct': 'Proxy desactivado',
  'proxy-mode-auto': 'Entorno',
  ...
  'proxy-http-only-hint': 'Aria2 Next solo admite proxy HTTP. No se admite proxy SOCKS',
  ...
  'auto-select-all-files-from-extension-hint': 'Al activarlo, todas las tareas comenzarán en silencio',
  ...
  'async-dns-hint': 'Puede mejorar el rendimiento, pero puede ser inestable o impedir descargas',
