export default {
  ...
  'engine-ready': 'Dong co Aria2 Next da san sang',
  'engine-failed': 'Không thể khởi động engine',
  'engine-stopped': 'Dong co Aria2 Next da dung',
  ...
  'engine-dismiss-warning': 'Dong co tai xuong Aria2 Next khong chay, co the xay ra hanh vi khong mong muon',
  'engine-verifying-stability': 'Dong co tai xuong Aria2 Next da khoi dong, dang xac minh tinh on dinh...',
  ...
  'protocol-hijacked-dialog-content': 'Phát hiện giao thức {protocols} chưa được liên kết với Motrix Next, các liên kết liên quan sẽ không thể tự động mở ứng dụng.\nĐiều này thường do cài đặt lần đầu, cập nhật phiên bản hoặc công cụ tải xuống khác chiếm quyền liên kết. Bạn có thể bật lại liên kết giao thức tương ứng trong Cài đặt → Cài đặt nâng cao.',
  'dismiss': 'Đã hiểu',
