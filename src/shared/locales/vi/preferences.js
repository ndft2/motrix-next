export default {
  ...
  'seeding-mode': 'Chế độ chia sẻ',
  'seeding-mode-stop-by-condition': 'Dừng khi đạt điều kiện',
  'seeding-mode-manual-stop': 'Dừng thủ công',
  'seeding-mode-manual-stop-tips': 'Tải xuống đã hoàn tất sẽ tiếp tục chia sẻ cho đến khi bạn dừng tác vụ thủ công',
  ...
  'proxy-http-only-hint': 'Aria2 Next chỉ hỗ trợ proxy HTTP. Proxy SOCKS không được hỗ trợ',
